...
void loadRoomData(int currentRoom) {
    switch (dungeon[currentRoom].roomType) {
        case ALCHEMYLAB:
            ...
            DMANow(3, alchemybgTiles, &CHARBLOCK[1], alchemybgTilesLen / 2);
            break;
        case ATRIUM:
            DMANow(3, atriumbgPal, PALETTE, 256);
            DMANow(3, atriumbgMap, &SCREENBLOCK[28], atriumbgMapLen / 2);
            DMANow(3, atriumbgTiles, &CHARBLOCK[1], atriumbgTilesLen / 2);
            break;
        case BEDROOM:

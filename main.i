...
void initialize() {
    ...
    (*(volatile unsigned short*)0x400000A) = ((0)<<2) | ((28)<<8) | (1<<14);
...
void goToGame() {
    ...
    DMANow(3, gameinstructionsTiles, &((charblock *)0x6000000)[1], 1344 / 2);
...
void goToCombat(CHARACTER * enemy) {
    ...
    DMANow(3, combatinstructionsTiles, &((charblock *)0x6000000)[1], 1152 / 2);
